...
things if asked in your project defense -- they answer different
questions (a trained classifier's forecast vs. a hand-weighted
composite of current conditions).
