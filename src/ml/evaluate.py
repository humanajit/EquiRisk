...
you'll actually eyeball and compare model accuracy). Keeping this logic
...
def compare_models(results: dict, labels: list) -> pd.DataFrame:
    ...
    -- this is the table you'll want to display in
    notebooks/04_model_training_comparison.ipynb to justify which model
    you picked."""
    rows = []
